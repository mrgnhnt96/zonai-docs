...
_.c=-1
_.$ti=f},
kV(d,e,f,g,h,i){if(C.c.aq(i,4)!==0)throw B.e(B.Z("Invalid base64 padding, padded length must be multiple of four, is "+i,d,f))
...
if(w===0)return A.lr(a3<a3?C.a.m(a4,0,a3):a4,5,a2).gd2()
else if(w===32)return A.lr(C.a.m(a4,5,a3),0,a2).gd2()}v=B.b2(8,0,!1,x.S)
C.b.i(v,0,0)
C.b.i(v,1,-1)
C.b.i(v,2,-1)
C.b.i(v,7,-1)
...
if(n==null)if(u>0)n=A.kw(a4,0,u)
...
e=A.ot(a4,t,s,!1)
m=s+1
if(m<r){d=A.ld(C.a.m(a4,m,r),a2)
h=A.kv(d==null?B.aJ(B.Z("Invalid port",a4,m)):d,n)}}else{e=a2
f=""}a0=A.ou(a4,r,q,a2,n,e!=null)
a1=q<p?A.ov(a4,q+1,p,a2):a2
return A.fQ(n,f,e,h,a0,a1,p<a3?A.os(a4,p+1,a3):a2)},
...
ls(a2,a3,a4){var w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0="an address must contain at most 8 parts",a1=new A.ic(a2)
...
t=""
if(d.charCodeAt(u)!==118){s=A.or(d,u,v)
if(s<v){r=s+1
...
return A.oq(u?d.toLowerCase():d)},
oq(d){if(d==="http")return"http"
if(d==="file")return"file"
if(d==="https")return"https"
if(d==="package")return"package"
return d},
ow(d,e,f){return A.dW(d,e,f,16,!1,!1)},
ou(d,e,f,g,h,i){var w,v=h==="file",u=v||i
if(d==null)return v?"/":""
else w=A.dW(d,e,f,128,!0,!0)
if(w.length===0){if(v)return"/"}else if(u&&!C.a.E(w,"/"))w="/"+w
return A.ox(w,h,i)},
ox(d,e,f){var w=e.length===0
if(w&&!f&&!C.a.E(d,"/")&&!C.a.E(d,"\\"))return A.lO(d,!w||f)
return A.cv(d)},
ov(d,e,f,g){if(d!=null)return A.dW(d,e,f,256,!0,!1)
return null},
os(d,e,f){return A.dW(d,e,f,256,!0,!1)},
kx(d,e,f){var w,v,u,t,s,r,q=y.f,p=e+2,o=d.length
if(p>=o)return"%"
w=e+1
...
if(p)return B.lf(f&&65<=r&&90>=r?(r|32)>>>0:r)
if(v>=97||u>=97)return C.a.m(d,e,e+3).toUpperCase()
return null},
ku(d){var w,v,u,t,s,r,q,p,o="0123456789ABCDEF"
...
t=2}v=3*t
w=new Uint8Array(v)
for(s=0;--t,t>=0;u=128){r=C.c.e2(d,6*t)&63|u
...
q=2}}}p=A.ku(r)}if(s==null){s=new B.ab("")
o=s}else o=s
o.a=(o.a+=C.a.m(d,t,u))+p
if(typeof q!=="number")return B.ml(q)
u+=q
...
if(u)break}return d},
oz(d,e){if(d.ex("package")&&d.c==null)return A.me(e,0,e.length)
return-1},
lL(d){var w=d|32
return 97<=w&&w<=122},
lr(d,e,f){var w,v,u,t,s,r,q,p,o="Invalid MIME type",n=B.a([e-1],x.t)
...
break}}C.b.l(n,v)
q=v+1
if((n.length&1)===1)d=F.J.eF(d,q,w)
...
lA(d){if(d.b===7&&C.a.E(d.a,"package")&&d.c<=0)return A.me(d.a,d.e,d.f)
return-1},
...
pP(d){if(A.m8(d))return d
return new A.jS(new B.dz(x.A)).$1(d)},
mp(d,e){var w=new B.x($.z,e.h("x<0>")),v=new B.bq(w,e.h("bq<0>"))
d.then(B.aI(new A.k_(v,e),1),B.aI(new A.k0(v),1))
return w},
...
this.b=e},
mt(d){var w=C.a.d9(d.toLowerCase(),B.eR("\\s+")),v=B.W(w),u=v.h("bR<1>")
w=B.aO(new B.bR(w,v.h("a0(1)").a(new A.k3()),u),u.h("f.E"))
return w},
q1(b3,b4){var w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2=A.mt(b4)
...
a2=a0.b
a2=a2==null?g:f+a2
C.b.l(j,new A.aR(a2,o,l,a1,A.q3(a4,b2),a8))}if(j.length===0)continue
C.b.ab(j,new A.k1())
o=new B.bP(j,0,3,r)
o.dn(j,0,3,s)
C.b.B(u,o)}C.b.ab(u,new A.k2())
return B.f5(u,0,B.fZ(24,"count",x.S),s).eX(0)},
q3(d,e){var w,v,u,t,s,r,q,p,o,n,m,l=d.length
if(l===0)return""
w=d.toLowerCase()
...
_.e=h
_.f=i},
ld(d,e){var w,v=/^\s*[+-]?((0x[a-f0-9]+)|(\d+)|([a-z0-9]+))\s*$/i.exec(d)
...
$iB:1}
A.eg.prototype={
eF(a2,a3,a4){var w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",a0="Invalid base64 encoding length ",a1=a2.length
a4=B.ch(a3,a4,a1)
w=$.mI()
...
l=A.jN(a2.charCodeAt(o))
k=o+1
if(!(k<a1))return B.d(a2,k)
j=A.jN(a2.charCodeAt(k))
i=l*16+j-(j&256)
if(i===37)i=-1
...
cu(d,e){var w,v,u,t,s,r,q,p,o
for(w=0,v=0;C.a.F(e,"../",v);){v+=3;++w}u=C.a.ey(d,"/")
t=d.length
...
s=l.d
r=l.e
if(d.gcU())q=d.gb7()?d.gaI():l.f
else{p=A.oz(l,r)
if(p>0){o=C.a.m(r,0,p)
r=d.gbP()?o+A.cv(d.ga2()):o+A.cv(l.cu(C.a.M(r,o.length),d.ga2()))}else if(d.gbP())r=A.cv(d.ga2())
else if(r.length===0)if(t==null)r=w.length===0?d.ga2():A.cv(d.ga2())
else r=A.cv("/"+d.ga2())
else{n=l.cu(r,d.ga2())
v=w.length===0
if(!v||t!=null||C.a.E(r,"/"))r=A.cv(n)
else r=A.lO(n,!v||t!=null)}q=d.gb7()?d.gaI():null}}}m=d.gbR()?d.gb6():null
return A.fQ(w,u,t,s,r,q,m)},
gbQ(){return this.c!=null},
gb7(){return this.f!=null},
gbR(){return this.r!=null},
gcU(){return this.e.length===0},
gbP(){return C.a.E(this.e,"/")},
j(d){return this.gcF()},
K(d,e){var w,v,u,t=this
if(e==null)return!1
if(t===e)return!0
w=!1
if(x.R.b(e))if(t.a===e.gaO())if(t.c!=null===e.gbQ())if(t.b===e.gc3())if(t.gb8()===e.gb8())if(t.gaH()===e.gaH())if(t.e===e.ga2()){v=t.f
u=v==null
if(!u===e.gb7()){if(u)v=""
if(v===e.gaI()){v=t.r
u=v==null
...
ga2(){return this.e}}
A.ia.prototype={
gd2(){var w,v,u,t,s=this,r=null,q=s.c
if(q==null){q=s.b
...
gbP(){return C.a.F(this.a,"/",this.e)},
...
gaH(){var w,v=this
if(v.gbS())return A.pM(C.a.m(v.a,v.d+1,v.e))
w=v.b
...
bZ(d){return this.aK(A.ib(d))},
aK(d){if(d instanceof A.aw)return this.e3(this,d)
return this.cH().aK(d)},
e3(d,e){var w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g=e.b
if(g>0)return e
w=e.c
if(w>0){v=d.b
if(v<=0)return e
...
else if(u&&C.a.E(d.a,"http"))t=!e.cs("80")
else t=!(v===5&&C.a.E(d.a,"https"))||!e.cs("443")
if(t){s=v+1
return new A.aw(C.a.m(d.a,0,s)+C.a.M(e.a,g+1),v,w+s,e.d+s,e.e+s,e.f+s,e.r+s,d.w)}else return this.cH().aK(e)}r=e.e
g=e.f
if(r===g){w=e.r
if(g<w){v=d.f
s=v-g
...
if(w<g.length){v=d.r
return new A.aw(C.a.m(d.a,0,v)+C.a.M(g,w),d.b,d.c,d.d,d.e,d.f,w+(v-w),d.w)}return d.eN()}w=e.a
if(C.a.F(w,"/",r)){q=d.e
p=A.lA(this)
o=p>0?p:q
s=o-r
...
cH(){var w=this,v=null,u=w.gaO(),t=w.gc3(),s=w.c>0?w.gb8():v,r=w.gbS()?w.gaH():v,q=w.a,p=w.f,o=C.a.m(q,w.e,p),n=w.r
p=p<n?w.gaI():v
...
t=B.G(t,x.v)
t.B(0,v.ax)
t.B(0,H.kE().$1$2$onChange$onInput(u,v.x,v.$ti.c))
...
t.z=w.b.test(u)
t.d=B.co(B.h(v.window),"keydown",x.E.a(t.gdN()),!1,x.m)},
b4(){var w=this.d
if(w!=null)w.a4()
this.bC(!1)
this.cc()},
dO(d){var w,v,u=B.u(d.key).toLowerCase()
...
v.L(new A.is(v))
v.bC(!1)},
bC(d){var w,v=B.o(B.h(b.G.document).documentElement)
...
t=4
w=7
return B.fU(A.mp(B.h(B.h(b.G.window).fetch(r.cC("search-index.json"))),x.m),$async$az)
case 7:q=e
...
f=C.l
w=8
return B.fU(A.mp(B.h(q.text()),x.N),$async$az)
case 8:p=g.a(f.bM(e,null))
o=B.a([],x.V)
j=J.kS(p,"docs")
j.toString
j=J.ar(x.j.a(j))
...
cC(d){var w=A.ib(B.u(B.h(b.G.document).baseURI))
...
dS(){var w,v=this.y,u=this.as,t=u.length
if(v>=t)return
w=B.h(B.h(b.G.window).location)
if(!(v>=0))return B.d(u,v)
w.href=this.cC(u[v].a)},
dQ(d){B.h(d)
...
s.push(K.fX(B.a([new G.b4(y.b,u),w,E.c5(B.a([new B.K(v.z?"\u2318K":"Ctrl K",u)],t),"search-trigger-keys",u)],t),r,"search-trigger",u,v.gdR(),u))
if(v.e)s.push(v.dF())
return new L.bj(s,u)},
dF(){var w,v=this,u=null,t=v.f,s=x.N,r=B.a_(["aria-label","Search"],s,s),q=x.v,p=B.a_(["click",new A.it(v),"cancel",new A.iu(v)],s,q),o=B.a_(["placeholder","Search the docs\u2026","autocomplete","off","spellcheck","false","aria-label","Search query"],s,s)
q=B.a_(["keydown",v.gdP()],s,q)
s=B.a_(["type","button","aria-label","Close search"],s,s)
w=x.i
return new A.h0(t,"docs-search-dialog","search-dialog",r,p,B.a([D.bu(B.a([D.bu(B.a([new G.b4(y.b,u),new A.e6(M.C,new A.iv(v),"docs-search-input",o,q,u,x.g),K.fX(B.a([new B.K("Esc",u)],w),s,"search-dismiss",u,v.gdu(),u)],w),"search-field",u),D.bu(B.a([v.dW()],w),"search-results",u),D.bu(B.a([E.c5(B.a([new G.b4("<kbd>\u2191</kbd><kbd>\u2193</kbd> to navigate",u)],w),u,u),E.c5(B.a([new G.b4("<kbd>\u21b5</kbd> to open",u)],w),u,u),E.c5(B.a([new G.b4("<kbd>esc</kbd> to close",u)],w),u,u)],w),"search-footer",u)],w),"search-panel",u)],w),u)},
dW(){var w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d=this,a0=null,a1="search-empty",a2=d.w
...
return D.bu(B.a([new B.K("No matches for \u201c"+w+"\u201d. ",a0),E.c5(B.a([new B.K("Live updates are documented as \u201cstream\u201d / \u201clisten\u201d.",a0)],v),"search-hint",a0)],v),a1,a0)}u=A.mt(w)
w=x.i
v=B.a([],w)
...
$S:5}
A.k0.prototype={
$1(d){if(d==null)return this.a.bJ(new A.hR(d===undefined))
return this.a.bJ(d)},
$S:5}
A.iB.prototype={
$0(){var w=this.a
...
var u
w(u=A.ds.prototype,"gdN","dO",0)
v(u,"gdR","cA",1)
v(u,"gdu","aU",1)
w(u,"gdP","dQ",0)})();(function inheritance(){var w=a.inherit,v=a.inheritMany
w(A.bJ,B.f)
w(A.ca,A.bJ)
v(B.l,[A.bK,A.dV,A.ia,A.aw,A.hR,A.eV,A.eW,A.aR])
w(A.eg,B.c8)
w(A.hh,B.cM)
v(B.bC,[A.ic,A.k1,A.k2])
w(A.fp,A.dV)
v(B.aj,[A.jS,A.k_,A.k0,A.it,A.iu,A.iv,A.iE,A.k3])
